...
- **SECTION_NAME** = [Human-readable name, e.g., "Dashboard & Home" or "Trip Creation & Input"]
- **SECTION_ID** = [Folder name in sections/, e.g., "dashboard-home" or "trip-creation-input"]

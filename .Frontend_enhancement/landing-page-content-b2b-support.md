# Landing Page Content - B2B Support AI (Single-Column)

Designed for mobile-first readability with a clean, single-column flow. All copy is ready to paste into a design or no-code tool.
...
- (Icon: Clock) Resolve ~60% of inquiries instantly, 24/7. [cite: 598]
- (Icon: Shield/Checkmark) Deliver accurate answers with citations from your content.
- (Icon: Puzzle Piece/Logo) Activate inside your existing system. No code required.

Visual:
Short 15 to 30 second looping GIF or video thumbnail showing [Product] resolving a real ticket.
...
Visual:
Clean dashboard screenshot or place the explainer video here if it is not used in the hero.

---

## Social Proof and Trust ("Trusted by Leading B2B Teams")
Customer Logos:
Logo strip of recognizable B2B brands (4 to 8 logos).
...
Credibility Badges:
SOC 2 Type II, GDPR Compliant, ISO 27001 (if applicable)
...
Headline:
More Than Just a Chatbot: Fully Integrated AI Support
...
Ready to cut ticket volume and deliver instant, trusted answers?
...
Note:
Do not include the main website navigation menu in the footer.

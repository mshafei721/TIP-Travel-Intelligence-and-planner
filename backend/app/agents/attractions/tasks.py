...
def create_attractions_task(agent, input_data: AttractionsAgentInput) -> Task:
    """
    ...
    interests = ", ".join(input_data.interests) if input_data.interests else "general tourism"
